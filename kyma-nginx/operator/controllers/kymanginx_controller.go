...
import (
	...
	operatorv1alpha1 "github.com/adityabhatia/kcd-demo/kyma-nginx/api/v1alpha1"
...
// KymaNginxReconciler reconciles a KymaNginx object
type KymaNginxReconciler struct {
...
func (m ManifestResolver) Get(object types.BaseCustomObject) (types.InstallationSpec, error) {
	sample, valid := object.(*operatorv1alpha1.KymaNginx)
	if !valid {
...
func (r *KymaNginxReconciler) initReconciler(mgr ctrl.Manager) error {
	manifestResolver := &ManifestResolver{}
	return r.Inject(mgr, &operatorv1alpha1.KymaNginx{},
...
//+kubebuilder:rbac:groups=operator.kyma-project.io,resources=kymanginxes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.kyma-project.io,resources=kymanginxes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.kyma-project.io,resources=kymanginxes/finalizers,verbs=update
...
func (r *KymaNginxReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&operatorv1alpha1.KymaNginx{}).
		Complete(r)
}
